      ...
      <div className="lg:col-span-2 md:col-span-2 col-span-1 z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3">
          <div className="bg-buttonBG flex justify-center items-center gap-4 px-3 py-6 text-white">
            <div className="text-3xl text-red-600 bg-white p-3 rounded-2xl">
              <FaUsers />{" "}
            </div>
            <div>
              <p className="text-xl"> Happy Customers </p>
              <p className="text-2xl font-bold flex">
                <Counter increment={1} targetNumber={21} /> k
              </p>
            </div>
          </div>
          <div className="bg-orange-300 flex justify-center items-center gap-4 px-3 py-6 text-black">
            <div className="text-3xl text-white bg-buttonBG p-3 rounded-2xl">
              <FaBagShopping />{" "}
            </div>
            <div>
              <p className="text-xl"> Brands </p>
              <p className="text-2xl font-bold flex">
                <Counter increment={2} targetNumber={20} />+
              </p>
            </div>
          </div>
          <div className="bg-buttonBG flex justify-center items-center gap-4 px-3 py-6 text-white">
            ...
            <div>
              ...
              <div className="text-2xl font-bold flex">
                <Counter increment={1} targetNumber={600} /> +
              </div>
            </div>
          </div>
        </div>
