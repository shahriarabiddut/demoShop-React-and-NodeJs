        ...
        <div className="grid gap-5 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mx-auto w-11/12 py-20">
          <div className="flex justify-center">
            <img
              src={image}
              alt={itemName}
              className="w-10/12 border-2 border-base-200 rounded-xl p-1 bg-orange-400 shadow-2xl"
            />
          </div>
          <div className="overflow-x-auto flex flex-col gap-3">
            <h2 className="text-4xl font-barlow font-semibold text-buttonBG">
              {itemName}
            </h2>
            <h3 className="text-2xl font-barlow font-semibold text-buttonBG">
              $ {price}
            </h3>
            <h3 className="text-2xl font-barlow font-semibold text-gray-600">
              {brand}
            </h3>
            ...
            <p className="text-xl font-barlow ">
              <span className="font-semibold">{soldQuantity}</span> items
              allready sold!
            </p>
            <p className="text-xl font-barlow ">
              <span className="font-semibold">Category : </span> {category}
            </p>
            <div className="text-xl font-barlow ">
