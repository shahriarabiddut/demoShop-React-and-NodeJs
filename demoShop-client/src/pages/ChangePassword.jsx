        ...
        <div className="mx-auto">
          ...
          >
            ...
            <div className="form-control my-6">
              <button className="btn bg-buttonBG text-white font-semibold hover:text-buttonBG hover:font-bold hover:bg-white">
                Reset
              </button>
            </div>
            <div className="form-control">
              <label className="label">
                <span className="label-text">
                  New to this website?{" "}
                  <NavLink
                    className="text-buttonBG font-bold hover:text-purple-800"
                    to="/auth/register"
                  >
                    Create an Account
                  </NavLink>{" "}
