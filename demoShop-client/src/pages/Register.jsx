...
const Register = () => {
  ...
  const { createNewUser, setUser, updateUserProfile, showToast } =
  ...
  return (
    <div className="min-h-fit flex justify-center items-center py-10">
      ...
      <section className="w-10/12 mx-auto my-1 grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="form-control flex flex-row gap-3">
                <label className="label font-semibold mx-auto">
                  <span className="label-text">
                    ...
                    <NavLink
                      className="text-buttonBG font-bold hover:text-blue-500"
                      to="/auth/login"
                    >
                      Login
                    </NavLink>{" "}
